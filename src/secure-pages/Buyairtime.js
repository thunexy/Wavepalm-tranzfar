  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        >
          <Text style={{ color: "#49add3", margin: 0, padding: 0 }}>
            Select your country
          </Text>
          <Picker
            style={{ color: "#000", width: "100%", height: 45 }}
        ...
        {this.state.selectedCountry !== null && (
          ...
          >
            {(this.state.selectedCountry == "Nigeria" ||
              ...
              <Text style={{ color: "#49add3", marginBottom: 10 }}>
                Select a network
              </Text>
            )}
        ...
        <View style={{ width: "100%" }}>
          <Text
            style={{ color: "#49add3", marginHorizontal: 10, paddingTop: 15 }}
          >
            Phone Number
          </Text>
